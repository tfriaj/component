...
var path = {
  src: {
    ...
    js: "app/js/*.js",
    scss: "app/scss/**/*.scss",
    images: "app/images/**/*.+(png|jpg|jpeg|gif|svg|webp)",
    fonts: "app/fonts/**",
    doc: "documentation/**/*.*",
...
gulp.task("fonts:free:build", function () {
  return gulp
    .src(path.src.fonts)
    .pipe(gulp.dest(path.build.dirFree + "fonts/"));
});
...
gulp.task("others:free:build", function () {
  return gulp.src(path.src.others).pipe(gulp.dest(path.build.dirFree));
});
...
gulp.task("others:premium:build", function () {
  return gulp.src(path.src.others).pipe(gulp.dest(path.build.dirPremium));
});
...
// Fonts
gulp.task("fonts:netlify:build", function () {
  return gulp
    .src(path.src.fonts)
    .pipe(gulp.dest(path.build.dirNetlify + "fonts/"));
});
